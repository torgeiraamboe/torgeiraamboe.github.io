...
<span style="color:orange"> **Definition:** </span> A *filtration* on a spectrum $X$ is a $\mathbb{Z}$-graded sequence of spectra $X_\bullet$, such that $X$ is the homotopy colimit $X\simeq \underrightarrow{\lim}_kX_k$. A *filtered spectrum* is then a spectrum together with a chosen filtration. 
